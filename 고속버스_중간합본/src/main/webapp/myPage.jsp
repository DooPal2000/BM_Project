...
<head>
<link rel="stylesheet" type="text/css" href="header_side/Loginpage.css">
<meta charset="UTF-8">
...
.password_Info, .btn_sm_link_blue {
	color: #778899;
...
<body>
	<div class="page">
		...
		<div class="myPage">
			<div class="container">
				<strong class="strong_br">계정정보</strong><br> <span
					class="detail">${userInfo.id}테스트</span>
				<%--유저 아이디 --%>
				<div class="btnBox">
					<a href="chgPw.jsp" class="password_Info">비밀번호 변경 <span
						class="span_b">></span></a>&nbsp;&nbsp;&nbsp; <a href="#"
						class="btn_sm_link_blue" onclick="showModal()">회원탈퇴<span
						class="span_b"> ></span></a>
				</div>
			</div>
			<div class="container">
				<strong class="strong_br">이메일주소</strong><br> <span
					class="detail">${userInfo.email }테스트</span>
				<div class="btnBox">
					<a href="email_Info.jsp" class="email_Info">이메일주소 변경 <span
						class="span_b">></span></a>
				</div>
			</div>
						...
						<div class="inner">
							<div class="present">
								<div style="padding: 10px;">
									<label for="pre" class="presize">비밀번호</label><br> <input
										type="password" class="password_pre" name="password" id="pre"
										placeholder="현재 사이트에 등록된 비밀번호를 입력하세요.">
								</div>
							</div>
						</div>
					</div>
