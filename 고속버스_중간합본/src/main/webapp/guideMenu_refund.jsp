...
<body>
	...
	<section>
		<p id="Text1">
			카드결제, 계좌이체, 프리미엄 마일리지로 예매한<br>고속버스 승차권 환불 규정에 대한 안내입니다.
		</p>
		<p id="Text2">승차권 환불 규정</p>
		<div id="circle">
			<img src="images/guideMenu_refund_icon.png">
		</div>
		<ul id="refundText">
			<li>승차권을 환불하신 후(승객용) 승차권을 교부 받으시면 정상적으로 환불 처리가 되었음을 의미하며 안심하셔도
				됩니다.</li>
			...
			<li>카드사 홈페이지에서 고속버스승차권의 이용내역을 조회하실 경우 가급적 결제일을 전후하여 청구내역(거래승인내역이
				아님)을 조회하시기 바랍니다. 또한 카드사의 사정에 따라 환불내역이 조회되지 않을 수 있습니다.</li>
			<li>신용카드 승차권의 환불은 구입했을 당시의 신용카드로 환불됩니다. 타인의 신용카드로 구입한 승차권 환불 시
				본인은 환불 받으실 수 없습니다.</li>
			<li>계좌이체 예매취소 시 즉시 예매 당시의 출금계좌로 입금되나 장애 발생 시 최대 1시간까지 입금이 지연될 수도
				있습니다.</li>
			<li>프리미엄 마일리지로 예매한 승차권 취소 시, 마일리지 수수료 정책에 따라 처리됩니다.<br> -
				출발시간 이전 취소 시 100% 마일리지 환급<br> - 출발시간 이후 취소 시 100% 마일리지 차감
			</li>
		</ul>
	</section>
</body>
