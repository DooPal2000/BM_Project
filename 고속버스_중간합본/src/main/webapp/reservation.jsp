	...
	<section>
		...
		<div id="rightBox">
			...
			<div id="boxSide">
				<ul>
					<li>
						...
						<div class="countBtn">
							<input id="btn" type="button" onclick="count('plus','general')" value="+">
							<input id="btn" type="button" onclick="count('minus','general')" value="-">
						</div>
					</li>
					<li>
			...
			<div id="seatImg">
				...
				<div id="seatList">
					<span class="seat">
						<input type="checkbox" name="seatBox" id="seatNum2801" value="1">
						<label for="seatNum2801">1</label>
					</span>
					<span class="seat">
						<input type="checkbox" name="seatBox" id="seatNum2802" value="2">
						<label for="seatNum2802">2</label>
					</span>
					<span class="seat">
						<input type="checkbox" name="seatBox" id="seatNum2803" value="3">
						<label for="seatNum2803">3</label>
					</span>
					<span class="seat">
						<input type="checkbox" name="seatBox" id="seatNum2804" value="4">
						<label for="seatNum2804">4</label>
					</span>
					<span class="seat">
						<input type="checkbox" name="seatBox" id="seatNum2805" value="5">
						<label for="seatNum2805">5</label>
					</span>
					<span class="seat">
						<input type="checkbox" name="seatBox" id="seatNum2806" value="6">
						<label for="seatNum2806">6</label>
					</span>
					<span class="seat">
						<input type="checkbox" name="seatBox" id="seatNum2807" value="7">
						<label for="seatNum2807">7</label>
					</span>
					<span class="seat">
						<input type="checkbox" name="seatBox" id="seatNum2808" value="8">
						<label for="seatNum2808">8</label>
					</span>
					<span class="seat">
						<input type="checkbox" name="seatBox" id="seatNum2809" value="9">
						<label for="seatNum2809">9</label>
					</span>
					<span class="seat">
						<input type="checkbox" name="seatBox" id="seatNum2810" value="10">
						<label for="seatNum2810">10</label>
					</span>
					<span class="seat">
						<input type="checkbox" name="seatBox" id="seatNum2811" value="11">
						<label for="seatNum2811">11</label>
					</span>
					<span class="seat">
						<input type="checkbox" name="seatBox" id="seatNum2812" value="12">
						<label for="seatNum2812">12</label>
					</span>
					<span class="seat">
						<input type="checkbox" name="seatBox" id="seatNum2813" value="13">
						<label for="seatNum2813">13</label>
					</span>
					<span class="seat">
						<input type="checkbox" name="seatBox" id="seatNum2814" value="14">
						<label for="seatNum2814">14</label>
					</span>
					<span class="seat">
						<input type="checkbox" name="seatBox" id="seatNum2815" value="15">
						<label for="seatNum2815">15</label>
					</span>
					<span class="seat">
						<input type="checkbox" name="seatBox" id="seatNum2816" value="16">
						<label for="seatNum2816">16</label>
					</span>
					<span class="seat">
						<input type="checkbox" name="seatBox" id="seatNum2817" value="17">
						<label for="seatNum2817">17</label>
					</span>
					<span class="seat">
						<input type="checkbox" name="seatBox" id="seatNum2818" value="18">
						<label for="seatNum2818">18</label>
					</span>
					<span class="seat">
						<input type="checkbox" name="seatBox" id="seatNum2819" value="19">
						<label for="seatNum2819">19</label>
					</span>
					<span class="seat">
						<input type="checkbox" name="seatBox" id="seatNum2820" value="20">
						<label for="seatNum2820">20</label>
					</span>
					<span class="seat">
						<input type="checkbox" name="seatBox" id="seatNum2821" value="21">
						<label for="seatNum2821">21</label>
					</span>
					<span class="seat">
						<input type="checkbox" name="seatBox" id="seatNum2822" value="22">
						<label for="seatNum2822">22</label>
					</span>
					<span class="seat">
						<input type="checkbox" name="seatBox" id="seatNum2823" value="23">
						<label for="seatNum2823">23</label>
					</span>
					<span class="seat">
						<input type="checkbox" name="seatBox" id="seatNum2824" value="24">
						<label for="seatNum2824">24</label>
					</span>
					<span class="seat lastSeat">
						<input type="checkbox" name="seatBox" id="seatNum2825" value="25">
						<label for="seatNum2825">25</label>
					</span>
					<span class="seat lastSeat">
						<input type="checkbox" name="seatBox" id="seatNum2826" value="26">
						<label for="seatNum2826">26</label>
					</span>
					<span class="seat lastSeat">
						<input type="checkbox" name="seatBox" id="seatNum2827" value="27">
						<label for="seatNum2827">27</label>
					</span>
					<span class="seat lastSeat">
						<input type="checkbox" name="seatBox" id="seatNum2828" value="28">
