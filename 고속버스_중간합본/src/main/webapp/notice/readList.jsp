	...
	<div class="page">
		...
		<div class="board_view">
			<div class="titlelabel">
				...
				<span style="text-align: right"> 2019.02.26 </span>
			</div>

		</div>
	</div>
	<div class="page_b">
		<img src="images/im4.png" alt="img4" class="img_cl"> <img
			src="images/im5.png" alt="img5" class="img_cl"> <img
			src="images/im6.png" alt="img6" class="img_cl"> <img
			src="images/im7.png" alt="img7" class="img_cl">
		<div class="btnscol1">
