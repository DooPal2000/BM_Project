	...
	<div class="pagecustomer">
		...
		<div class="board_view">
			...
			<div class="cont">
				<p>&nbsp;</p>
				<div>
					<b>[노쇼 방지를 위한 동일 카드 예매 횟수 변경 안내]</b>
				</div>
				<div>
					<br>
				</div>
				<div>
					○ 적용일 : <b>2019년 8월 17일부터~<br>
					<br></b>
				</div>
				<div>
					○ 대상 : <b>KOBUS 홈페이지, 고속버스 티머니 APP 예매</b> (터미널 매표소 발권 시는 제외)
				</div>
				<div>
					<br>○ 변경 내용 :
				</div>
				<div>- 홈페이지, 모바일 APP 예매 시 출발일 기준 동일 카드로 4회 초과 예매 제한. (1회 - 최대
					6장 예매 가능)&nbsp;</div>
				<div>- 홈페이지, 모바일 APP 예매 시 동일 출발일 터미널 매표소 발권 횟수 포함하여 4회 초과 제한.</div>
				<div>&nbsp; (단, 터미널 매표소 발권 시에는 홈페이지, 모바일 APP 예매 횟수 상관없이 발권 가능)</div>
			</div>
		</div>
