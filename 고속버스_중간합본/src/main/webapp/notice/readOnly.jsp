	...
	<div class="page">
		...
		<div class="board_view">
			<div class="titlelabel">
				...
				<span style="text-align: right"> 2021.06.21 </span>
			</div>
		...
		<div class="cont">
			...
			<div style="text-align: center;" align="center">
				<b><span style="font-size: 11pt;">비회원 예매 프로세스 변경 관련 안내
						(12/30~)</span></b>
			</div>
			<span style="font-size: 11pt;">&nbsp;<br></span><br>
			<span style="font-size: 11pt;">비회원 예매 프로세스가 기존 로그인 방식에서 인증
				방식으로 변경됩니다.</span><br>
			<span style="font-size: 11pt;"><br>고속버스티머니 APP 최신버전을
				사용하시는 분들은, 홈페이지에서 비회원 예매한 내역을 APP에서 조회 시<br>기존 로그인 방식으로는 불가한
				경우, 결제한 카드번호로 예매내역 조회를 부탁드립니다.&nbsp;</span><br>
		</div>
