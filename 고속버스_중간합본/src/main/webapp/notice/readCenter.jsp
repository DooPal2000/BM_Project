...
<body>
	<div class="pagecustomer">
		...
		<div class="board_view">
			...
			<div class="cont">
				<p>&nbsp;</p>
				<div>안녕하십니까. 티머니 입니다.</div>
				<div>항상 저희 티머니를 이용해주시는 고객님께 깊은 감사를 드립니다.</div>
				<div>
					<br>
				</div>
				<div>
					<b>2019년 9월 1일부터 고객센터 점심시간이 다음과 같이 운영되어 안내드리오니 이용에 참고하여 주시기
						바랍니다.&nbsp;</b>
				</div>
				<div>
					<br>
				...
				<div>○ 상담 제한 안내</div>
				<div>
					<b>- 점심시간에는 ARS 안내, 문자서비스, 장애 상담만 가능합니다.</b>
				</div>
				<div>
					<b>- 일반 상담 업무는 제한되며, 13시 이후부터 모든 상담이 가능합니다.</b>
				</div>
				<div>
					<br>
				</div>
				<div>앞으로 더 좋은 상담 품질 서비스가 제공될 수 있도록 노력하겠습니다.</div>
				<div>
					<br>
				</div>
				<div>감사합니다.</div>
