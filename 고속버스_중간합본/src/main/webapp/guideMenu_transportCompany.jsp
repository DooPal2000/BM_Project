...
<body>
	...
	<section>
		<p id="Text1">
			고속버스 운송회사 목록입니다.<br>
			<span>각 운송사별 홈페이지에서 자세한 정보 확인이 가능합니다.</span>
		</p>
		<div id="Table">
			<div class="terms_wrap">
				<table id="companyTable">
					...
					<tr>
						...
						<td colspan="2">1544-4888 <span
							onclick="document.location.href='https://www.kumhobuslines.co.kr/fr/main/main'">바로가기
								></span></td>
					</tr>
					<tr>
						<td>(주)동부고속</td>
						<td>서울특별시 서초구 신반포로 194, 924호<br> (반포동, 서울고속버스터미널)
						</td>
						<td colspan="2">1688-3287 <span
							onclick="document.location.href='http://www.dongbubus.com/jsp/express/main/index.jsp'">바로가기
								></span></td>
					</tr>
					<tr>
						<td>(주)동양고속</td>
						<td>경기도 안양시 동안구 홍안대로 67(호계동)</td>
						<td colspan="2">02)535-3111 <span
							onclick="document.location.href='http://www.dyexpress.co.kr/'">바로가기
								></span></td>
					</tr>
					<tr>
						<td>(주)삼화고속</td>
						<td>인천광역시 중구 서해대로 418번길 70(신흥동3가,2층)</td>
						<td colspan="2">032)508-1580 <span
							onclick="document.location.href='http://www.samhwaexpress.co.kr/'">바로가기
								></span></td>
					</tr>
				</table>
			</div>
