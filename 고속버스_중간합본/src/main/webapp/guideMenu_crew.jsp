...
<body>
	...
	<section>
		<p id="Text1">
			국민안전 승무원제<br>
			<span>국민안전 승무원제 해당 좌석은 3번 좌석입니다.</span>
		</p>
		<p id="Text2">국민안전 승무원제란?</p>
		<p id="Text3">
			3번 좌석을 이용하는 승객이 교통사고나 화재가 발생하였을경우 <span>다른 승객들의 안전을 확보하는데 도움을
				주고</span> 고속버스의 이상 운행 및 이상 징후 포착시 운전기사에게 알려 <span>교통사고를 예방하고 피해를
				최소화하고자</span> 도입한 자율적 참여제도입니다.
		</p>
		<p id="Text2">혜택</p>
		<p id="Text3">
			고속버스 통합 홈페이지 (www.kobus.co.kr) 또는 모바일 앱 회원으로 가입후 해당 노선의 프리미엄 <span>고속버스
				3번 좌석</span>을 예매하였을 경우 <span>요금의 2% 마일리지 적립 및 추가로 1% 마일리지가 적립</span>됩니다.
		</p>
		<ul id="crewList">
