...
.password_pre, .password_info, .passwordOK_info {
	background-color: #D3D3D3;
	border: none;
	padding-top: 10px;
	font-size: 17px;
			...
			<div class="container-box">
				<div class="present">
					<div style="padding: 10px;">
						<label for="pre" class="presize">현재 비밀번호</label><br> <input
							type="password" class="password_pre" name="password"
							id="prePassword" placeholder="현재 비밀번호를 입력하세요">
					</div>
				</div>
				<div class="present">
					<div style="padding: 10px;">
						<label for="newPassword" class="presize">새 비밀번호</label><br> <input
							type="password" class="password_info" name="newPassword"
							id="newPassword" placeholder="영문, 숫자 8자리 이상">
					</div>
				</div>
				<div class="present">
					<div style="padding: 10px;">
						<label for="newPasswordOK" class="presize">새 비밀번호 확인</label><br>
						<input type="password" class="passwordOK_info" id="newPasswordOK"
