...
<body>
		...
		<form action="searchId.do" method="post">
			<div class="container">
				<div class="container-box">
					<div class="find_id">
						<label for="email" class="email_label">이메일</label><br> <input
							type="email" name="email" id="email" class="email_input"
							size="40" placeholder="이메일 찾기">
					</div>
					<div>
	...
	<div class="page_wrap">
		...
		<div class="wrapper">
			<a href="#"><button class="btn_password">비밀번호 찾기</button></a> <a
