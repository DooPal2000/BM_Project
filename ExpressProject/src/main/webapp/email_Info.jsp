			...
			<div class="container-box">
				<div class="present">
					<div style="padding: 10px;">
						<label for="pre" class="presize" name="password">비밀번호</label><br>
						<input type="password" class="password_pre" name="" id="pre"
				...
				<div class="present">
					<div style="padding: 10px;">
						<label for="email" class="presize">이메일</label><br> <input
							type="email" class="email_info" name="email" id="email"
