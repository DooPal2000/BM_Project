...
<body>
	<form action="busRegisterOK.do">
		<table border="1">
			...
			<tr>
				<td>출발터미널</td>
				<td><select name="b_startTerminal">
			...
			<tr>
				<td>도착터미널</td>
				<td><select name="b_arrivalTerminal">
						<c:forEach var="terminalList" items="${terminalList}">
							<option value="${terminalList.t_name }">${terminalList.t_name }</option>
						</c:forEach>
				</select></td>
			...
			<tr>
				<td colspan="2"><input type="submit" value="배차정보 등록"> <input
					type="reset" value="전체지우기"></td>
			</tr>
		</table>
	</form>
</body>
