			...
			<form action="membership.do" method="get">
				<div class="inputBox">
					...
					<div class="box" id="sexBox">
						<p>성별</p>
						<input type="radio" name="sex" value="f" id="f"> <label
							for="f">여자 ♀</label> <input type="radio" name="sex" value="m"
							id="m"> <label for="m">남자 ♂</label>
					</div>
					<h4>
						개인정보 수집 및 이용동의<span>(선택)</span>
					</h4>
					<span class="check"> <input type="checkbox" id="agree"
						class="checkBox"> <label for="agree"><i
							class="xi-check"></i>동의</label>
					</span>
						...
						<div class="terms_wrap">
							...
							<table>
								...
								<tr>
									...
									<td>동의 철회 또는 회원 탈퇴 시 까지 (단, 관련 법령에 별도의 규정이 있는 경우에는 그 기간을
										따름)</td>
								</tr>
							</table>
