...
<body>
	...
	<section>
		...
		<div class="tabs">
			...
			<label for="roundtrip">왕복 <span class="material-symbols-outlined">sync_alt</span>
			</label>
		</div>
		<div id="tabs_1">
				...
				<div id="date" class="position">
					...
					<div id="dayChoice">
						...
						<label id="todaybtn" for="today">오늘</label>
						<input type="radio" id="tomorrow" name="day">
						<label id="tomorrowbtn" for="tomorrow">내일</label>
					</div>
